...
export default  async function NewListingPage(){
    ...
    const activeOrganizationMemnberships = organizationMemberships.data.filter(om => om.status === 'active');
    const organizationsNames:{[key:string]:string} = {};
    for(const activeMembership of activeOrganizationMemnberships){
...
return(
    <div className="container">  
      ...
      <div>
            ...
            {organizationMemberships.data.length === 0 && ( <div className="border border-blue-200 bg-blue-50 p-4 rounded-md" >
            ...
            <Link 
                className="inline-flex gpa-2 items-center bg-gray-200 px-4 py-2 rounded-md  mt-6"
                href={'/new-company'}>
